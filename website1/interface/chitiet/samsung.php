<?php
  if(isset($_POST["samsung"])){
  	$sql_samsung="select * from chitiethang where hangthietbi like '%samsung%'";
  	$run_samsung=mysqli_query($conn,$sql_samsung);
?>
<div class="row">
...
<div class="row">
<?php 
if(mysqli_num_rows($run_samsung)>0){
while ($row_samsung=mysqli_fetch_array($run_samsung)) { ?>
	<div class="col-md-3 bg-white">
	<img src="quantri/model/chitietsp/upload/<?php echo $row_samsung['hinhanh'];?>" width="80px" height="100px"><br>
		Sản Phẩm : <?php echo $row_samsung["tenchitiet"];?><br>
	    Giá : <?php echo $row_samsung["gia"];?><br>
		<a href="index.php?xem=thongtinsp&id=<?php echo $row_samsung['id_chitiet']?>">Xem chi Tiết</a>
	</div>
<?php }
}else {
