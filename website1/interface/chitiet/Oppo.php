<?php
  if(isset($_POST["oppo"])){
  	$sql_oppo="select * from chitiethang where hangthietbi like '%Oppo%'";
  	$run_oppo=mysqli_query($conn,$sql_oppo);
?>
<div class="row">
...
<div class="row">
<?php 
if(mysqli_num_rows($run_oppo)>0){
while ($row_oppo=mysqli_fetch_array($run_oppo)) { ?>
	<div class="col-md-3 bg-white">
	<img src="quantri/model/chitietsp/upload/<?php echo $row_oppo['hinhanh'];?>" width="80px" height="100px"><br>
		Sản Phẩm : <?php echo $row_oppo["tenchitiet"];?><br>
	    Giá : <?php echo $row_oppo["gia"];?><br>
		<a href="index.php?xem=thongtinsp&id=<?php echo $row_oppo['id_chitiet']?>">Xem chi Tiết</a>
	</div>
<?php }
}else {
